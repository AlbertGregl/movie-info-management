...
public class ArticleParser {
    ...
    public static List<Article0708> parse() throws IOException, XMLStreamException {
    ...
    private static void handlePicture(Article0708 article, String pictureUrl) {
