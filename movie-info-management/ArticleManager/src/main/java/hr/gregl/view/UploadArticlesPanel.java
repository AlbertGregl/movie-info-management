...
import hr.gregl.parsers.rss.ArticleParser;
...
public class UploadArticlesPanel extends javax.swing.JPanel {
    ...
    private void btnUploadArticlesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUploadArticlesActionPerformed
        try {
            List<Article0708> articles = ArticleParser.parse();
    ...
    private javax.swing.JList<Article0708> lsArticles;
    // End of variables declaration//GEN-END:variables

    private DefaultListModel<Article0708> articlesModel;
    ...
    private void loadModel() throws Exception {
        List<Article0708> articles = repository.selectArticles();
        articlesModel.clear();
