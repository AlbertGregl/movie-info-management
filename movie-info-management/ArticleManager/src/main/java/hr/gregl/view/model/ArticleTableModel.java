...
public class ArticleTableModel extends AbstractTableModel{
    ...
    private List<Article0708> articles;

    public ArticleTableModel(List<Article0708> articles) {
        this.articles = articles;
    }

    public void setArticles(List<Article0708> articles) {
        this.articles = articles;
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch (columnIndex) {
            ...
            case 5:
                return articles.get(rowIndex).getPublishedDate().format(Article0708.DATE_FORMATTER);
            default:
