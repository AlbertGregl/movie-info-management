...
import hr.gregl.view.model.ArticleTableModel;
...
public class EditArticlesPanel extends javax.swing.JPanel {
    ...
    private Repository0708 repository;
    private ArticleTableModel articlesTableModel;

    private Article0708 selectedArticle;
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        try {
            ...
            Article0708 article = new Article0708(
                    tfTitle.getText().trim(),
                    tfLink.getText().trim(),
                    taDescription.getText().trim(),
                    localPicturePath,
                    LocalDateTime.parse(tfPublishedDate.getText().trim(), Article0708.DATE_FORMATTER)
            );
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            ...
            selectedArticle.setPublishedDate(LocalDateTime.parse(tfPublishedDate.getText().trim(), Article0708.DATE_FORMATTER));
    ...
    private boolean formValid() {
        ...
        for (int i = 0; i < validationFields.size(); i++) {
            ...
            if ("Date".equals(validationFields.get(i).getName())) {
                try {
                    LocalDateTime.parse(validationFields.get(i).getText().trim(), Article0708.DATE_FORMATTER);
                } catch (Exception e) {
                    ok = false;
    ...
    private void showArticle() {
        ...
        try {
            Optional<Article0708> optArticle = repository.selectArticle(selectedArticleId);
    ...
    private void fillForm(Article0708 article) {
        ...
        tfPublishedDate.setText(article.getPublishedDate().format(Article0708.DATE_FORMATTER));
    }
